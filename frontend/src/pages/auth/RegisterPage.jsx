    ...
    <div style={{ fontFamily: "'Plus Jakarta Sans', 'DM Sans', sans-serif" }}>
      ...
      <div className="grid grid-cols-2 gap-3 mb-5">
        <button type="button"
          ...
          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '10px 16px', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.15)', background: 'rgba(255,255,255,0.08)', color: 'white', fontSize: '14px', fontWeight: '500', cursor: 'pointer' }}
        >
        ...
        <button type="button"
          ...
          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '10px 16px', borderRadius: '10px', border: '1px solid #1877F2', background: '#1877F2', color: 'white', fontSize: '14px', fontWeight: '500', cursor: 'pointer' }}
        >
