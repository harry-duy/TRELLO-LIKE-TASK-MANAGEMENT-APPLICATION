...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!email.trim() || !password) {
      toast.error(t('loginRequiredFields'));
      return;
    }
        ...
        <div>
          ...
          <input
            ...
            style={{
              ...inputStyle,
              borderColor:
                focused === 'email' ? 'rgba(139,92,246,0.8)' : 'rgba(255,255,255,0.12)',
              boxShadow:
                focused === 'email' ? '0 0 0 3px rgba(139,92,246,0.15)' : 'none',
            }}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            style={{
              ...
              boxShadow:
                focused === 'password' ? '0 0 0 3px rgba(139,92,246,0.15)' : 'none',
            }}
          />
        </div>
